...
namespace PocketNurse
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PocketNurseContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("PocketNurseContext")));
            ...
            services.AddScoped<INotInFormularyRepository, NotInFormularyRepository>();
