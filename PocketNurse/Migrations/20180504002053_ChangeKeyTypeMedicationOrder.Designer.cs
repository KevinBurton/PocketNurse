...
namespace PocketNurse.Migrations
{
    ...
    [Migration("20180504002053_ChangeKeyTypeMedicationOrder")]
    partial class ChangeKeyTypeMedicationOrder
    {
            ...
            modelBuilder.Entity("PocketNurse.Models.MedicationOrder", b =>
                {
                    ...
                    b.Property<string>("PatientCabinetSessionId");
                    ...
                    b.HasIndex("PatientId", "PatientCabinetSessionId");
            ...
            modelBuilder.Entity("PocketNurse.Models.Patient", b =>
                {
                    ...
                    b.HasKey("PatientId", "CabinetSessionId");
            ...
            modelBuilder.Entity("PocketNurse.Models.MedicationOrder", b =>
                {
                    b.HasOne("PocketNurse.Models.Patient", "Patient")
                        .WithMany()
                        .HasForeignKey("PatientId", "PatientCabinetSessionId");
                });
